                        ...
                        <CardGroup>
                            ...
                            noValidate>
                                <Form.Group className="mb-3 justify-content-md-center" controlId="registration-card">
                                    ...
                                    <Form.Control min="5" type="text" name="username" placeholder="Username" value={username}
                                ...
                                <Form.Group className="mb-3 justify-content-md-center" controlId="formBirthday">
                                    ...
                                    <Form.Control type="birthday" name="birthday" placeholder="MM/DD/YYYY" value={birthday}
